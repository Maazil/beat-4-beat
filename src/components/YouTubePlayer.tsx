...
const YouTubePlayer: Component<YouTubePlayerProps> = (props) => {
  ...
  return (
    <div class="fixed inset-x-0 bottom-0 z-50 border-t-2 border-ink bg-paper px-4 py-3">
      <div class="mx-auto flex max-w-7xl items-center gap-4">
        {/* Video box — covered until the host reveals it */}
        <div class="relative aspect-video h-24 shrink-0 overflow-hidden rounded-lg border border-line bg-ink">
          <iframe
            ref={iframe}
            src={src()}
          ...
          />
          <Show when={!revealed()}>
            <div class="absolute inset-0 flex items-center justify-center bg-ink">
              <span class="font-display text-3xl font-bold text-cream">?</span>
            </div>
          </Show>
        </div>
        ...
        <div class="flex min-w-0 flex-1 flex-col gap-1">
          ...
          <div class="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              class="rounded-full border border-line px-3 py-1 text-xs font-semibold text-muted transition hover:border-ink hover:text-ink"
            >
        ...
        <button
          ...
          class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-ink text-cream shadow-md transition hover:bg-beat"
        >
