...
const Room: Component = () => {
  ...
  const allRooms = createMemo(() => rooms);
  const currentRoom = createMemo(() => 
    params.id ? allRooms().find((r) => r.id === params.id) : null
  );
                ...
                {(room) => (
                  ...
                  >
                    ...
                    <div class="space-y-2 text-sm text-neutral-500">
                      <p>
                        <span class="font-medium text-neutral-700">Deltakere:</span> {room.participants}
                      </p>
                      {room.startsAt && (
                        <p>
                          <span class="font-medium text-neutral-700">Starter:</span>{" "}
        ...
        {(room) => (
          <div class="flex flex-col w-full">
            ...
            <div class="flex items-start justify-between mb-8">
              <div>
                <h1 class="text-3xl font-semibold text-neutral-900">{room.name}</h1>
            ...
            <div class="grid gap-6 lg:grid-cols-2">
              <section class="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
                <h2 class="text-lg font-semibold text-neutral-900 mb-4">Rominformasjon</h2>
                <dl class="space-y-3 text-sm">
                  ...
                  {room.startsAt && (
                    <div>
                      <dt class="font-medium text-neutral-700">Starttidspunkt</dt>
              ...
              <section class="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
                <h2 class="text-lg font-semibold text-neutral-900 mb-4">Handlinger</h2>
