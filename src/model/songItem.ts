...
export const demoSongItems: SongItem[] = [
  {
    ...
    level: 1,
    songUrl:
      "https://open.spotify.com/track/5CtI0qwDJkDQGwXD1H1cLb?si=d378916995b3457d",
    startTime: 30,
    isRevealed: false,
  },
  {
    ...
    level: 2,
    songUrl:
      "hhttps://open.spotify.com/track/7CSQp9T3JtkjQGPmpR1vTb?si=4f65da5f08cd4756",
    isRevealed: false,
  },
  {
    id: "song-003",
    level: 3,
    songUrl:
      "https://open.spotify.com/track/7rcbwjIaZ5jEgyFk35Bqfj?si=1555eda05cc749dd",
    startTime: 45,
    isRevealed: false,
  },
];
