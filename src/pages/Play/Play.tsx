...
const Play: Component = () => {
  ...
  const [showGuestPrompt, setShowGuestPrompt] = createSignal(
  ...
  const joinAsGuest = () => {
    ...
    auth.loginAsGuest(name || undefined);
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div class="w-full max-w-md rounded-xl bg-white p-8 shadow-2xl">
            ...
            <p class="mb-6 text-neutral-600">
              Skriv inn navnet ditt for å spille som gjest, eller logg inn for
              full tilgang.
            </p>
            ...
            <input
              ...
              class="mb-4 w-full rounded-lg border border-neutral-300 px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none"
            />
            ...
            <div class="flex flex-col gap-3">
              ...
              <button
                ...
                class="w-full rounded-lg border-2 border-blue-600 px-6 py-3 font-semibold text-blue-600 transition hover:bg-blue-50"
              >
                Logg inn
              </button>
            </div>
            ...
            <p class="mt-4 text-center text-sm text-neutral-500">
              Gjestebrukere kan spille, men ikke opprette rom.
            </p>
          </div>
        </div>
      </Show>
