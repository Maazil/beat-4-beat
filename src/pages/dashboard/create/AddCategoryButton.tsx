...
const AddCategoryButton: Component<AddCategoryButtonProps> = (props) => {
  return (
    <button
      ...
      class="flex h-24 w-40 shrink-0 flex-col items-center justify-center gap-3 rounded-2xl border-2 border-dashed border-line bg-paper/60 text-muted transition hover:border-beat hover:bg-beat-soft/40 hover:text-beat disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:border-line disabled:hover:bg-paper/60 disabled:hover:text-muted md:h-38 md:w-56"
    >
